...
\addsec[Illustrations supplémentaires]{Illustrations supplémentaires}

\begin{figure}[p]
\includegraphics[page=1,width=0.95\textwidth]{pictures/app_fig.png}
\caption[Titre alpha court d'une illustration annexe]{Titre alpha long d'une illustration supplémentaire en annexe}
\end{figure}